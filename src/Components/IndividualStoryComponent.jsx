        ...
        {contentData ? (
          contentData === null ? (
            ...
            <>
              ...
              <div className='mt-[40px] font-semibold h-[35px] w-full bg-sky-100 rounded flex justify-end items-center pr-[20px]'>
                <span className=' text-gray-600 ml-auto font-cursive'>{userInfo.name}</span>
              </div>
